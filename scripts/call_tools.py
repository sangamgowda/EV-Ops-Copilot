...
CALLS = [
    ("resolve_entity_tool", {"vehicle_id": "VIN-1O42"}),
    ("structured_query_tool", {"sql": (
        ...
        "WHERE v.vehicle_id = 'VIN-1042' AND b.metric_name = 'current_draw' "
        "AND b.drive_mode = 'city'")}),
...
async def main() -> None:
    ...
    async with MCPClient() as client:
        ...
        late = await client.call_tool("resolve_entity_tool", {"vehicle_id": "VIN-1007"}, "turn-1")
